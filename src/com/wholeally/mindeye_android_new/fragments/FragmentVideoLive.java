...
public class FragmentVideoLive  extends Fragment
{
	...
	{
		view = inflater.inflate(R.layout.fragment_video_live, null);
		initUI();
		return view;
	}
	...
	private void initUI()
	{
		listView = (ListView)view.findViewById(R.id.listView_fragment_video_live);
		imageView_novideo = (ImageView)view.findViewById(R.id.imageView_fragment_video_live_novideo);
		textView_novideo = (TextView)view.findViewById(R.id.textView_fragment_video_live_novideo);
	}
